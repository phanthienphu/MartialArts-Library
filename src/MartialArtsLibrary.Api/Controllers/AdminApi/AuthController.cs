using MartialArtsLibrary.Api.Extensions;
...
namespace MartialArtsLibrary.Api.Controllers.AdminApi
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private async Task<List<string>> GetPermissionsByUserIdAsync(string userId)
        {
            ...
            {
                var types = typeof(Permissions).GetTypeInfo().DeclaredNestedTypes;//lấy hết các class trong class Permissions
